...
(tel. kontaktowy: Piotr Berus +48 733 888 031)
...
**Do bezpłatnego wyjazdu** potrzebna będzie karta parkingowa, który dostaniecie Państwo od nas przy pierwszym wspólnym spotkaniu z nami (dzień montażowy lub rano - przed wydarzeniem). **Do kolejnych wjazdów i wyjazdów trzeba korzystać z karty parkingowej (niczego nie pobieramy z parkomatu)**

## Dzień montażowy (opcjonalny) - 13 kwietnia
...
UWAGA: W przypadku podklejania wykładzin we własnym zakresie (brak wykupienia stosownej usługi od nas) jedyną rekomendowaną opcją jest profesjonalna taśma dwustronna ETG firmy Imawex (nie prowadzimy jej sprzedaży). Typowa (=marketowa) taśma dwustronna jest nie do usunięcia po wydarzeniu co wygeneruje dodatkowe (naprawdę kosmiczne) koszty sprzątania, które będziemy musieli refakturować.
