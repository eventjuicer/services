...
Pod koniec poprzedniego tygodnia udostępniliśmy możliwość zaproszenia Twoich kluczowych Partnerów do Strefy VIP - opcję znajdziesz w panelu wystawcy!
...
Adres URL do tej strony możesz wysłać osobie odpowiedzialnej za działania reklamowe w firmie lub do innych osób, które mają konta na serwisach społecznościowych - ** można skorzystać z linków udostępniających link do Twojej strony Wystawcy w serwisach społecznościowych.**

Wszystkie materiały mają dodany specjalny link, który:

a) **kieruje do profilu Wystawcy** (ta strona nie tylko opisuje Twoją firmę ale też pokazuje **lokalizację Twojego stoiska** na hali targowej) 
