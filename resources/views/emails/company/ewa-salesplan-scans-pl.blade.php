...
Jeśli Przedstawiciele Twojej firmy skanowali identyfikatory Zwiedzających podczas czwartkowych Targów - prosimy o pilne pobranie listy z danymi kontaktowymi z panelu. **Uwaga:** Lista zawiera dane kontaktowe Uczestników z wszystkich edycji, podczas których skanowaliście identyfikatory. Aby rozwiać ew. wątpliwości należy skorzystać z opcji EXPORT. Pobrany plik zawiera kolumnę z datą skanowania.
...
(Jeśli nie pamiętasz swojego miejsca w rankingu Konkursu dla Wystawców, w TEN czwartek otrzymasz od nas informację kiedy odbędzie się sprzedaż dla Twojej firmy.)
