...
**Tylko osoby fizycznie obecne na Targach otrzymają dostęp do wszystkich nagrań prezentacji ze scen A, B, C i D** 

@endcomponent


Właśnie **[uruchomiliśmy możliwość umawiania się na spotkanie z Wystawcą](https://targiehandlu.pl/exhibitors) i wyszukiwania firm po nazwie lub branży** , w której działają.

Jak umówić się na spotkanie z Wystawcą?
...
(3b) Kliknij na stoisko, kliknij przycisk "Umów się na spotkanie."
...
**Jeśli Wystawca zaakceptuje Twoją propozycję otrzymasz możliwość korzystania ze strefy VIP.**
