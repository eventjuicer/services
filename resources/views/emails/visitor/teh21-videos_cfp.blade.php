...
Udostępniamy pierwszą porcję nagrań video z jubileuszowej 20. edycji Targów, która odbyła się w październiku. 
...
<table style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
    ...
    <tr>
        <td><img src="https://res.cloudinary.com/eventjuicer/image/upload/w_300,h_300,c_limit,f_auto/v1561617400/c_1500_logotype.jpg" alt="" /></td>
        <td>Kacper Gugała - Business Development Manager Poland - Shopware 
            <strong><a href="https://ehandel.com.pl/unikalny-sklep-jak-pozostac-w-swiadomosci-klienta,2187">Unikalny sklep. Jak pozostać w świadomości Klienta?</a></strong></td>
    </tr>
    <tr>
        <td><img src="https://res.cloudinary.com/eventjuicer/image/upload/w_300,h_300,c_limit,f_auto/v1637231628/c_1903_logotype.png" alt="" /></td>
    ...
    <tr>
        <td><img src="https://res.cloudinary.com/eventjuicer/image/upload/w_300,h_300,c_limit,f_auto/v1613654859/c_1142_logotype.png" alt="" /></td>
